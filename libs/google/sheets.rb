module Google
  ...
  class Sheets
    def initialize(config_file: "credentials", token_file: "sheets_token", file_id:)
      credentials_path = "libs/google/sheets/#{config_file}.secret.json".freeze
      token_path = "libs/google/sheets/#{token_file}.secret.yaml".freeze
